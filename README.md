...
Fork for this amazing tools to add more specific label on nodes views.

## HOW-TO

- build : `go build`
- configure view.yml used by this tools:

```
# on ~/Library/Application\ Support/k9s/views.yml
k9s:
  views:
    v1/pods:
      columns:
